      ...
      <div>
        ...
        <div>
          <div style={{ float: 'left' }}>
            <DayPicker onDayClick={this.handleDayClick} selectedDays={[day]} />
          </div>
        ...
        <Typography className={classes.title} color="textSecondary">
          Currently this feature only works with local ganache-cli, due to{' '}
          <a
            href="https://github.com/trufflesuite/ganache-cli/issues/243"
            target="blank"
          >
            complications with signing
          </a>
        </Typography>
      </div>
    )
