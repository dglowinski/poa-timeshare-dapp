...
class TstBook extends React.Component {
  ...
  render() {
    const { classes, booked, bookDay, loading, accessKey } = this.props
    ...
    return (
      <div>
        <Section
          heading="Check availability and book a day"
          icon="date_range"
        />
        <Typography className={classes.title} color="textSecondary">
          Check dates available in the calendar and make a booking. You need at
          least 1 TST.
        </Typography>
        <div>
